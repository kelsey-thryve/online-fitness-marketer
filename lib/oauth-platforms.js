...
export const PLATFORMS = {
  klaviyo: {
    ...
    usesPkce: true,  // Klaviyo OAuth requires PKCE (S256)

    buildAuthUrl({ clientId, state, redirectUri, scope, pkceChallenge: challenge }) {
    ...
    async exchangeCode({ code, clientId, clientSecret, redirectUri, pkceVerifier }) {
